(function () {
  ...
  function ensureStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      '.ww-carousel-widget{--ww-bg:#0b1220;--ww-surface:#111827;--ww-border:#243244;--ww-text:#e5e7eb;--ww-muted:#94a3b8;--ww-star:#fbbf24;--ww-primary:#38bdf8;--ww-shadow:0 16px 42px rgba(0,0,0,.45);font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;border:1px solid var(--ww-border);border-radius:24px;padding:16px;background:linear-gradient(180deg,#0b1220 0%,#0f172a 100%);color:var(--ww-text);box-shadow:var(--ww-shadow);overflow:hidden}',
